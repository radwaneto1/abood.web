...
$php_main_email = "aburadwanradwan887@gmail.com";
...
if (filter_var($php_email, FILTER_VALIDATE_EMAIL)) {
		...
		// message lines should not exceed 10 characters (PHP rule), so wrap it
		$php_sendmessage = wordwrap($php_sendmessage, 10);
